...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     * 这种模式实时性非常高。对消费者对本地队列有一个保护，因此本地消息队列不能无限大，否则可能会占用大量内存，本地队列大小由DefaultMQPushConsumer的
     * pullThresholdForQueue属性控制，默认1000
     */
     ...
     * 消息拉取线程拉取间隔时间由DefaultMQPushConsumer的pullInterval属性控制，默认为0
     */
    private long pullInterval = 0;

    /**
     * Batch consumption size
     * 监听器每次接受本地队列的消息数量是由参数DefaultMQPushConsumer的consumeMessageBatchMaxSize属性控制，默认为1
     */
