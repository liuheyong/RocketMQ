...
public class BrokerOuterAPI {
    ...
    public String getAllDelayOffset(final String addr) throws Exception {
    ...
    public SubscriptionGroupWrapper getAllSubscriptionGroupConfig(final String addr) throws Exception {
